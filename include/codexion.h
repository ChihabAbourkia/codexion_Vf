...
/*init.c*/
int		init_system(t_systeme *sim, t_config *config);

/*cleanup.c */
void	cleanup_system(t_systeme *sim, int nb_dongles, int nb_coders);
void	destroy_mutex(t_systeme *sim);
int		error(char *msg);
